...
#define MCL_TASK_CPU CL_DEVICE_TYPE_CPU //0x01 //CL_DEVICE_TYPE_CPU
#define MCL_TASK_GPU CL_DEVICE_TYPE_GPU //0x02 //CL_DEVICE_TYPE_GPU
#define MCL_TASK_FPGA CL_DEVICE_TYPE_ACCELERATOR //0x04 //CL_DEVICE_TYPE_ACCELERATOR -- does this make sense?
#define MCL_TASK_DF CL_DEVICE_TYPE_CUSTOM //0x10 //CL_DEVICE_TYPE_CUSTOM Q: How does the scheduler distinguish between different custom devices if they are all set to the same value?
#define MCL_TASK_VX CL_DEVICE_TYPE_CUSTOM //0x10 //CL_DEVICE_TYPE_CUSTOM  -- However, Vortex exposes itself as GPU.
#define MCL_TASK_PROTEUS CL_DEVICE_TYPE_CUSTOM //0x10 //CL_DEVICE_TYPE_CUSTOM
#define MCL_TASK_ANY (MCL_TASK_CPU | MCL_TASK_GPU | MCL_TASK_FPGA | MCL_TASK_DF | MCL_TASK_VX)
